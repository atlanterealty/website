...
const navigation = [
  ...
  { name: "Search Properties", href: "/brokerage" },
  {
    ...
    href: "/services",
    submenu: [
      { name: "Commercial Brokerage", href: "/services?service=commercial-brokerage" },
      { name: "Residential Brokerage", href: "/services?service=residential-brokerage" },
      { name: "Acquisitions", href: "/services?service=acquisitions" },
      { name: "Property Management", href: "/services?service=property-management" },
      { name: "Leasing", href: "/services?service=leasing" },
      { name: "Planning & Development", href: "/services?service=planning-development" },
      { name: "Real Estate Consulting", href: "/services?service=real-estate-consulting" },
    ]
  },
        ...
        <div className="flex h-16 items-center justify-between">
              ...
              <div key={item.name} className="relative group">
                <Link href={item.href}>
                  <Button
                    variant="ghost"
                    className={cn(
                      "text-sm font-medium text-foreground hover:text-white hover:gradient-gold transition-all duration-200",
                        ...
                        {item.submenu.map((subItem) => (
                          <div key={subItem.name}>
                            {item.name === "Services" ? (
                              <Button
                                variant="ghost"
                                className="w-full justify-start p-3 rounded-xl hover:text-white hover:gradient-gold transition-all duration-200"
                                onClick={() => {
          ...
          <div className="hidden lg:flex items-center space-x-3">
            <Link href="/contact">
              <Button
                variant="ghost"
                className="text-sm font-medium text-foreground hover:text-white hover:gradient-gold transition-all duration-200"
