  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  <Button
                    ...
                    onClick={() => window.open("https://www.atlanteschoolofrealestate.com/", "_blank")}
        ...
        {/* Programs Section */}
        <section id="programs-section" className="py-20 bg-background">
          <div className="container mx-auto px-4">
                ...
                <Card key={index} className="h-full hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-8 flex flex-col h-full">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        if (index === 0) {
                          // Pre-License Course - link to real estate school
                          window.open("https://www.atlanteschoolofrealestate.com/", "_blank");
                        } else {
                          // Continuing Education and Post-License - Coming Soon
                          return;
                        }
                      }}
                      disabled={index !== 0}
                    ...
                    >
                      ...
                      {index === 0 ? "Enroll Now" : "Coming Soon"}
                    </Button>
                  </CardContent>
                </Card>
              ))}
